import { useState, useEffect } from "million/react";
    ...
    <div className="App">
      <div>
        <a href="https://millionjs.org" target="_blank">
          ...
          <img
            src="https://raw.githubusercontent.com/aidenybai/million-react/main/public/million.svg"
            className="logo"
            alt="Million logo"
          />
        </a>
        <a href="https://reactjs.org" target="_blank">
          ...
          <img
            src="https://raw.githubusercontent.com/aidenybai/million-react/main/public/react.svg"
            className="logo"
            alt="React logo"
          />
        </a>
